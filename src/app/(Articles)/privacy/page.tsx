...
const page = ({}: pageProps) => {
  return (
    <div className="mx-auto my-4 flex max-w-2xl flex-col space-y-2">
      ...
      <ul className="list-disc space-y-1">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Info Library.
          </p>
        </li>
        <li>
          <p>
      ...
      <h4 className="border-b text-xl">Personal Data</h4>
      <p>
      ...
      <h4 className="border-b text-xl">Usage Data</h4>
      ...
      <h4 className="border-b text-xl">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h4 className="border-b text-xl">Business Transactions</h4>
      <p>
      ...
      <h4 className="border-b text-xl">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="border-b text-xl">Other legal requirements</h4>
      <p>
      ...
      <h2 className="pt-2 text-3xl font-bold">Children's Privacy</h2>
      <p>
      ...
      <h2 className="pt-2 text-3xl font-bold">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="pt-2 text-3xl font-bold">Contact Us</h2>
      <p>
