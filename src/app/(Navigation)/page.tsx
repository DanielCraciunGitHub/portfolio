...
export default async function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden pb-20 pt-16">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-border/50 bg-gradient-to-br from-background/90 to-background/50 p-8 shadow-2xl backdrop-blur-sm">
                ...
                <div className="absolute -bottom-4 -right-4 z-30 rounded-full border border-border/50 bg-card/90 px-4 py-2 shadow-lg backdrop-blur-sm">
                  <span className="text-sm font-semibold text-primary">
                    Comp sci student
                  </span>
                </div>
                <div className="absolute -bottom-4 -left-4 z-30 rounded-full border border-border/50 bg-card/90 px-4 py-2 shadow-lg backdrop-blur-sm">
                  <span className="text-sm font-semibold text-primary">
